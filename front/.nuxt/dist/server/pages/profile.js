...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/profile.vue?vue&type=template&id=255f6250&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('v-card',{staticStyle:{"margin":"10px"}},[_c('v-container',[_c('v-subheader',[_vm._v("내 프로필")]),_vm._v(" "),_c('v-form',{on:{"submit":function($event){$event.preventDefault();return _vm.onChangeNickName.apply(null, arguments)}},model:{value:(_vm.valid),callback:function ($$v) {_vm.valid=$$v},expression:"valid"}},[_c('v-text-field',{attrs:{"label":"닉네임","rules":_vm.nickNameRules,"required":""},model:{value:(_vm.nickName),callback:function ($$v) {_vm.nickName=$$v},expression:"nickName"}}),_vm._v(" "),_c('v-btn',{attrs:{"color":"blue","type":"submit"}},[_vm._v(" 수정")])],1)],1)],1),_vm._ssrNode(" "),_c('v-card',{staticStyle:{"margin":"10px"}},[_c('follow-list')],1)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/profile.vue?vue&type=template&id=255f6250&

// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/FollowList.vue?vue&type=template&id=5b52a8d9&
var FollowListvue_type_template_id_5b52a8d9_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('v-container',[_c('v-subheader',[_vm._v(" 팔로잉")]),_vm._v(" "),_c('v-list',[_vm._l((_vm.followingList),function(following){return _c('v-col',{key:following.id,staticStyle:{"display":"inline-block"},attrs:{"cols":"12","md":"4"}},[_c('v-list-item',[_c('v-list-item-avatar',{attrs:{"color":"indigo"}},[_c('span',{staticClass:"withe--text headline"},[_vm._v(" "+_vm._s(following.nickName[0]))])]),_vm._v(" "),_c('v-list-item-content',[_c('v-list-item-title',[_vm._v(_vm._s(following.nickName))])],1),_vm._v(" "),_c('v-list-item-action',[_c('v-icon',{on:{"click":function($event){return _vm.removeFollowing(following)}}},[_vm._v("mdi-minus-circle-outline")])],1)],1)],1)}),_vm._v(" "),(_vm.hasMoreFollowing)?_c('v-btn',{staticStyle:{"width":"100%"},attrs:{"color":"blue"},on:{"click":_vm.loadFollowing}},[_vm._v("더보기")]):_vm._e()],2)],1),_vm._ssrNode(" "),_c('v-container',[_c('v-subheader',[_vm._v(" 팔로워")]),_vm._v(" "),_c('v-list',_vm._l((_vm.followerList),function(follower){return _c('v-col',{key:follower.id,staticStyle:{"display":"inline-block"},attrs:{"cols":"12","md":"4"}},[_c('v-list-item',[_c('v-list-item-avatar',{attrs:{"color":"indigo"}},[_c('span',{staticClass:"withe--text headline"},[_vm._v(" "+_vm._s(follower.nickName[0]))])]),_vm._v(" "),_c('v-list-item-content',[_c('v-list-item-title',[_vm._v(_vm._s(follower.nickName))])],1),_vm._v(" "),_c('v-list-item-action',[_c('v-icon',{on:{"click":function($event){return _vm.removeFollwer(follower)}}},[_vm._v("mdi-minus-circle-outline")])],1)],1)],1)}),1),_vm._v(" "),(_vm.hasMoreFollower)?_c('v-btn',{staticStyle:{"width":"100%"},attrs:{"color":"blue"},on:{"click":_vm.loadFollower}},[_vm._v("더보기")]):_vm._e()],1)],2)}
var FollowListvue_type_template_id_5b52a8d9_staticRenderFns = []


// CONCATENATED MODULE: ./components/FollowList.vue?vue&type=template&id=5b52a8d9&
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  FollowListvue_type_template_id_5b52a8d9_render,
  FollowListvue_type_template_id_5b52a8d9_staticRenderFns,
  false,
  injectStyles,
  null,
  "3f0c7e01"
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VCol: VCol["a" /* default */],VContainer: VContainer["a" /* default */],VIcon: VIcon["a" /* default */],VList: VList["a" /* default */],VListItem: VListItem["a" /* default */],VListItemAction: VListItemAction["a" /* default */],VListItemAvatar: VListItemAvatar["a" /* default */],VListItemContent: components_VList["a" /* VListItemContent */],VListItemTitle: components_VList["b" /* VListItemTitle */],VSubheader: VSubheader["a" /* default */]})
...
/* harmony default export */ var profilevue_type_script_lang_js_ = ({
  ...
  fetch({
    ...
    return Promise.all([store.dispatch('users/loadFollowing', {
      offset: 0
...
installComponents_default()(profile_component, {VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VContainer: VContainer["a" /* default */],VForm: VForm["a" /* default */],VSubheader: VSubheader["a" /* default */],VTextField: VTextField["a" /* default */]})
